...
abstract class BaseFacebook
{
   ...
   */
  public $api_setting = array();
  public $is_multiquery = false;
  
  public function reset_api_setting() {
    $this->api_setting = array();
  }
...
/*    $result = json_decode($this->_oauthRequest(
  ...
  protected function _oauthRequest($url, $params) {
    ...
    foreach ($params as $key => $value) {
      if (!is_string($value)) {
        ...
        $params[$key] = Jsphon::encode($value);
      }
    }
  ...
  protected function parseSignedRequest($signed_request) {
    ...
    $data = Jsphon::decode(self::base64UrlDecode($payload),$this->api_setting, $this->is_multiquery,true);
